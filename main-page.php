...
<head>
  ...
  <!-- CSS
  ================================================== -->
  <link rel="stylesheet" href="landing-page/css/base.css">
  <link rel="stylesheet" href="landing-page/css/vendor.css">
  <link rel="stylesheet" href="landing-page/css/main.css">

  <!-- script
  ================================================== -->
  <script src="landing-page/js/modernizr.js"></script>
  <script src="landing-page/js/pace.min.js"></script>
...
<body id="top">
  ...
  <nav id="menu-nav-wrap">
    ...
    <ul class="nav-list">
      ...
      <li><a class="smoothscroll" href="#features" title="">Notable Alumni</a></li>
      <li><a class="smoothscroll" href="#download" title="">Alumni List</a></li>
      <li><a class="smoothscroll" href="#infos" title="">Events</a></li>
      <li><a class="smoothscroll" href="#subscribe" title="">Newsletter</a></li>
      <li><a class="smoothscroll" href="#testimonials" title="">From the ...</a></li>
    </ul>
    ...
    <section id="intro">
      ...
      <div class="row intro-content">
        <div class="col-twelve">
          ...
          <h3 class="animate-intro">The Alumni Association.</h3>

          <h1 class="animate-intro">
            We form the platform for keeping in touch with your college mates and also the current students.
          </h1>

          <div class="buttons">
            <a class="button stroke smoothscroll animate-intro" href="#infos" title="">Events</a>
            <a class="button stroke smoothscroll animate-intro" href="#download" title="">Download</a>
          </div>

          <img src="landing-page/images/app-screenshot-big.jpg" alt="" class="animate-intro">
    ...
    <section id="features">
      ...
      <div class="row section-intro group animate-this">
        <div class="col-twelve with-bottom-line">
          ...
          <h2 class="">Notable Alumni.</h2>

          <p class="lead">As Tiruvannamali Medical College we are very proud to list our students who have succeeded.</p>
      ...
      <div class="row features-wrap">
        ...
        <div class="features-list block-1-3 block-s-1-2 block-tab-full">
          ...
          <div class="bgrid feature animate-this">
            ...
            <span class="feature-count">Name</span>

            <div class="feature-content">

              <h3>What he does</h3>

              <p>A basic description<br>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit.
              </p>
    ...
    <section id="download">
      ...
      <div class="row download-content" >
        <div class="col-twelve">
          ...
          <div class="text-part">
            <h2 class="animate-this">Alumni List</h2>

            <p class="lead animate-this">If you are here to check the alumni, click the button below.</p>
          </div>

          <a class="button small animate-this" href="list-years.html">
            Go to the listing.
          </a>
          <a class="button small animate-this" href="edit-resume.html">
            Edit your details.
          </a>
        ...
        <div class="row info-entry-content">
          ...
          <div class="media-wrap">
            <div class="media animate-this"  data-animate="fadeInRight">
              <img src="landing-page/images/app-screenshot-small.jpg" alt="">
            </div>
          </div>

          <div class="col-six text-part">

            <h5 class="animate-this" data-animate="fadeInLeft">Events</h5>
            <h2 class="animate-this" data-animate="fadeInLeft">Alumni Meet 2018</h2>
      ...
      <div class="row testimonial-content">
        <div class="col-twelve">
          ...
          <h2 class="h01 animate-this">
            Message from the heads of our college.
          </h2>
          ...
          <div class="flexslider-controls animate-this">
            <ul class="flex-control-nav">
              <li><img src="landing-page/images/customer01.jpg" alt=""></li>
              <li><img src="landing-page/images/customer02.jpg" alt=""></li>
              <li><img src="landing-page/images/customer03.jpg" alt=""></li>
            </ul>
          </div>
  ...
  <footer id="main-footer">
    ...
    <div class="footer-bottom">
      ...
      <div class="copyright">
        <span>Design by <a href="http://www.styleshout.com/">CEG</a></span>
      </div>
    </div>
  ...
  <!-- Java Script
  ================================================== -->
  <script src="landing-page/js/jquery-2.1.3.min.js"></script>
